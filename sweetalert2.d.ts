 ...
 */
export as namespace Sweetalert2;
 ...
 */
declare function swal(title: string, message?: string, type?: swal.SweetAlertType): Promise<any>;
 ...
 *   })
 */
declare function swal(settings: swal.SweetAlertOptions): Promise<any>;
