...
export function _main (userParams) {
  ...
  return new Promise((resolve, reject) => {
    ...
    const succeedWith = (value) => {
      constructor.closePopup(innerParams.onClose, innerParams.onAfterClose) // @todo (zenflow): make closePopup an *instance* method
    ...
    const confirm = (value) => {
      if (innerParams.showLoaderOnConfirm) {
        constructor.showLoading() // @todo (zenflow): make showLoading an *instance* method
      }
